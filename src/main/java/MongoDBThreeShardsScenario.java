...
public class MongoDBThreeShardsScenario {
    ...
    /**
     * VM's update listener - whenever VM changes it status, try to submit new cloudlets
     */
    ...
    private List<Vm> createVms() {
        ...
        for (int i = 0; i < VMS; i++) {
            ...
            //Uses a CloudletSchedulerSpaceShared to schedule Cloudlets in the waiting queue when resources are available.
